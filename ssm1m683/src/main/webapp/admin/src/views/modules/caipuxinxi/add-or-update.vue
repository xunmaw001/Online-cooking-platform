<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="菜谱分类" prop="caipufenlei">
          <el-select :disabled="ro.caipufenlei" v-model="ruleForm.caipufenlei" placeholder="请选择菜谱分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="菜谱分类" prop="caipufenlei">
	      <el-input v-model="ruleForm.caipufenlei"
                placeholder="菜谱分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="营养" prop="yingyang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="营养"
                  v-model="ruleForm.yingyang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yingyang" label="营养" prop="yingyang">
                    <span>{{ruleForm.yingyang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="制作步骤" prop="zhizuobuzhou">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhizuobuzhou" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhizuobuzhou" label="制作步骤" prop="zhizuobuzhou">
                    <span v-html="ruleForm.zhizuobuzhou"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/caipufenlei/caipufenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.caipufenleiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.zhizuobuzhou = this.ruleForm.zhizuobuzhou.replace(reg,'../../../ssm1m683/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
